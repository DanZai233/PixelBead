...
export const MaterialGallery: React.FC<MaterialGalleryProps> = ({ onApplyMaterial, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/80 z-[2000] flex items-center justify-center p-4 md:p-6 backdrop-blur-sm">
      <div className="bg-white rounded-[2rem] md:rounded-[3rem] w-full h-[95vh] md:h-[85vh] shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="flex flex-1 min-h-0 overflow-hidden">
          <div className="md:w-72 lg:w-80 bg-slate-50 p-4 flex flex-col gap-4 overflow-y-auto shrink-0 border-r border-slate-200">
            <div>
