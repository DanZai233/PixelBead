...
- **K-Means 相似颜色合并** - 按目标颜色数智能归并相近颜色
- **多品牌色号系统** - 支持 MARD、COCO、漫漫、盼盼、咪小窝五大品牌
- **色号自动映射** - 根据选择的品牌自动显示对应色号
- **已有颜色优先映射** - 从色板或画布添加已有拼豆，映射时优先使用
- **严格模式** - 只映射到手头已有的颜色，不引入新色号
- **展开色板** - 按色系浏览、勾选并查看已有颜色统计
- **显示色号** - 在画布、颜色统计和导出图纸中显示品牌色号
